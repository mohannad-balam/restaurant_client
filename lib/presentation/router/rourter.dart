...
class AppRouter extends $AppRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(
          page: EditCategoryPageRoute.page,
          path: '/edit-category-page',
          guards: [AuthGuard()],
        ),
        AutoRoute(
          page: TablesPageRoute.page,
          path: '/table-page',
          guards: [AuthGuard()],
        ),
        AutoRoute(
          page: AddTablePageRoute.page,
          path: '/add-table-page',
          guards: [AuthGuard()],
        ),
        AutoRoute(
          page: EditTablePageRoute.page,
