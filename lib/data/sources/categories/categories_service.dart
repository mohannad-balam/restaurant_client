...
class CategoriesService extends ICategoriesService{
  ...
  Future<List<CategoryModel>> getAll() async{
    try{
      List<dynamic> response = await locator<HttpService>().request(HttpMethods.GET, ApiRoutes.categories, {});
  ...
  Future<List<MenuModel>> getCategoryMenu(String id) async{
    try{
      List<dynamic> response = await locator<HttpService>().request(HttpMethods.GET, ApiRoutes.menusCategory(id), {});
